...
<div class="container-fluid">
            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="/home" class="dropdown-item" type="button">Đăng xuất</a>
                    </div>
                </div>
    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        ...
        <div class="col-lg-4 col-6 text-left">
            <form action="/ASM/quan-ly-san-pham/search-client">
        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${page.getContent()}" var="sp">
                <tr>
                    ...
                    <td>${sp.donGia} VND</td>
                    <td>
                        <a href="/cart/${US.id}/add-tai-nghe/${sp.taiNgheId}" class="btn btn-primary">Add to Cart</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
